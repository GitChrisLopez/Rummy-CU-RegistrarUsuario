...
/**
 * Componente unificado para el procesamiento de mensajes de red. Opera en dos
 * modos, determinado por su construcción: - Modo Servidor: Dirige comandos de
 * clientes a la Pizarra de Juego (Blackboard). - Modo Cliente: Transforma
 * eventos de red del servidor en eventos locales (PropertyChange) para que el
 * Modelo los consuma.
 *
...
public class Procesador implements iProcesador {
    ...
    /**
     * Constructor para el CLIENTE. No recibe pizarra, por lo tanto, actuará
     * reenviando eventos al Modelo.
     */
    public Procesador() {
        this.pizarra = null;
    ...
    /**
     * Constructor para el SERVIDOR. Recibe la pizarra, por lo tanto, actuará
     * procesando lógica de juego.
     *
    ...
    /**
     * Agrega un PropertyChangeListener (oyente) al procesador. En el Modo
     * Cliente, esta función es utilizada por el Modelo para registrarse y
     * escuchar los eventos de la red.
     *
    ...
    /**
     * Implementación del método central de la interfaz iProcesador. Desacopla
     * el mensaje de red entrante y lo dirige a la lógica apropiada según el
     * modo de operación del procesador.
     *
     * * @param ipRemitente La dirección IP del remitente del mensaje.
     * @param mensaje El contenido serializado del mensaje recibido a través de
     * la red.
     */
    @Override
    public void procesar(String ipRemitente, String mensaje) {
        ...
        if (esModoServidor) {
            ...
            System.out.println("[Procesador Cliente] Reenviando evento: " + mensaje);
